...
/**
 * Clase de transaccion para la entidad de Clientes
 * Esta clase se comunica directamente con la base de datos
 * No está pensada para ser usada directamente por las interfaces de
 * usuario.
 * 
 * @author Fran
 */
