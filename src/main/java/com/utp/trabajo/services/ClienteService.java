...
public class ClienteService {
     ...
     * @param checkChanges true para forzar la actualización de la tabla aún así no hayan cambios CRUD
     * @throws com.utp.trabajo.exception.security.NotEnoughPermissionsException si no hay permisos de lectura
     */
     ...
     * @param rowsPerUpdate cantidad de filas a cargar cada que se desee cargar más desde la base de datos.
    ...
    /**
     * Obtiene un objeto <code>Cliente</code> con los datos del cliente solicitado.
     ...
     * @param cliente El objeto tipo <code>Cliente</code> a agregar a la base de datos
     ...
     * Por debajo tiene la misma implementación de <code>nuevoCliente(Cliente cliente)</code> pero se 
     ...
     * @param idCliente El objeto tipo {@code List<Long>} con los idCliente de los clientes a eliminar
